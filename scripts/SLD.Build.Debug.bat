...
@set cl_include= /Iexternal /Iinclude /Isrc /Isrc\allocators /Isrc\core /Isrc\hash /Isrc\input /Isrc\math /Isrc\memory /Isrc\os /Isrc\string /Isrc\xml /Isrc\win32 /Ivcpkg_installed\x64-windows\include
