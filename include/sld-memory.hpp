...
namespace sld {
    ...
    const memory_arena_id_t       memory_arena_commit               (const memory_reservation_id_t reservation_id);
    bool                          memory_arena_decommit             (const memory_arena_id_t       arena_id);
    bool                          memory_arena_validate             (const memory_arena_id_t       arena_id);
