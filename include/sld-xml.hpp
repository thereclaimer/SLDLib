...
namespace sld {
    ...
    SLD_API void                 xml_memory_init           (const void* memory, const u64 size);
    ...
    SLD_API const xml_hnd_node_t xml_node_get_next_sibling (const xml_hnd_node_t h_node, const xml_utf8_t* sibling_name);
    SLD_API const xml_hnd_node_t xml_node_add_sibling      (const xml_hnd_node_t h_node, const xml_utf8_t* sibling_name);
    SLD_API bool                 xml_node_get_attribute    (const xml_hnd_node_t h_node, const xml_utf8_t* attribute_name);
    
    SLD_API const xml_utf8_t*    xml_attrib_get_value      (const xml_hnd_attrib_t h_attrib);      
    SLD_API bool                 xml_attrib_set_value      (const xml_hnd_attrib_t h_attrib, const xml_utf8_t* value);      
